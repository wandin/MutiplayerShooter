...
ASExplosiveBarrel::ASExplosiveBarrel()
{
	...
	HealthComp = CreateDefaultSubobject<USHealthComponent>(TEXT("HalthComp"));
	...
	// set physics to allow any radial component affect us. 
	...
	RadialForceComp->bAutoActivate = false; // prevent component from tickking , and only use FireImpulse()
